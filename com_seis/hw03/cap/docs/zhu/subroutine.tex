...
\node[io, below of = start, yshift = -1cm](in1){Input parameter space of $\theta, \lambda, \delta$ \& depth $h$};
...
\node[io, below of = pro4, yshift = -1cm](out1){Output possible solution $\theta_0, \lambda_0, \delta_0, \bar {\bar {M_0}}$};
